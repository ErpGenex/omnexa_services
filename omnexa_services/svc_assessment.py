...
from omnexa_services.svc_gap_register import get_gap_status
from omnexa_services.svc_global_benchmark import get_global_svc_score

@frappe.whitelist()
def export_svc_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_SERVICES_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_svc_score(), get_gap_status()
